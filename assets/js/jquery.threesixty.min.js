...
;(function ( $, window, document, undefined ) {
	...
	$.fn.nextFrame = ThreeSixty.prototype.nextFrame = function(){
		$(this).each(function(i){
			...
			$this.find('.threesixty__frame').css({display: 'none'});
			$this.find('.threesixty__frame:eq(' + val + ')').css({display: 'block'});
		});
	};
	...
	ThreeSixty.prototype.onLoadAllComplete = function(objIndex) {
		...
		for(i; i < l; i++){
			...
			if ($this.hasClass('threesixty--catalog')) {
				html += '<img class="threesixty__frame" style="display:' + display + ';" data-index="' + i + '" src="' + pathTemplate.replace('{index}', i*5) + '"/>';
			} else {
				html += '<img class="threesixty__frame" style="display:' + display + ';" data-index="' + i + '" src="' + pathTemplate.replace('{index}', i) + '"/>';
			}
		}
		$this.html(html);
	...
	ThreeSixty.prototype.attachHandlers = function(objIndex) {
		...
		$this.on('mousedown', function(e){
			...
			// mouse up
			$(document, 'html', 'body').on('mouseup', that.onMouseUp);
	...
	ThreeSixty.prototype.onMove = function(screenX, screenY){
		if(isMouseDown){
			...
			$downElem.find('.threesixty__frame').css({display: 'none'});
			$downElem.find('.threesixty__frame:eq(' + val + ')').css({display: 'block'});
		}
	};
